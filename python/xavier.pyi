...
class Array:
    ...
    def broadcast(self, arg0: list[int]) -> Array: ...
    def broadcast_to(self, arg0: list[int]) -> Array: ...
    def copy(self) -> Array: ...
    ...
    @staticmethod
    def full(view: list[int], c: object, dtype: Dtype = ..., device: Device = ...) -> Array: ...
    @staticmethod
    def full_like(arr: Array, c: object, device: Device = ...) -> Array: ...
    def id(self) -> int: ...
    ...
    def numel(self) -> int: ...
    @staticmethod
    def ones_like(arr: Array, device: Device = ...) -> Array: ...
    ...
    def sqrt(self) -> Array: ...
    @staticmethod
    def zeros_like(arr: Array, device: Device = ...) -> Array: ...
